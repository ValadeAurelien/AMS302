...
%\question{13.1}{Trouver l'équation vérifiée par $\phi_{\eps}$ lorsque $\eps$ tend vers 0.}
%\question{13.2}{Dans le cas où on prend $\sigma_a = 0$ et $\sigma_t = 1$, trouver la limite de $\phi_\eps$ lorsque $\eps$ tend vers 0.}
%\question{14}{e}
